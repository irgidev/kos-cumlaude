...
<div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('fasilitas.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_fasilitas" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Contoh: AC Split, Meja Belajar, Kasur" required>
        </div>
